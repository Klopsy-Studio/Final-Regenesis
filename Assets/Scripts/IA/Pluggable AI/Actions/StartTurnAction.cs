...
public class StartTurnAction : Action
{
    ...
    //public void CheckRange(MonsterController controller)
    //{
    //    bool check1 = false;
    ...
    //        for (int i = 0; i < 3; i++)
    //        {
    //            tiles = attack2Range.GetTilesInRange(controller.battleController.board);
    ...
    //                    {
    //                        controller.targets.Add(e.GetComponent<PlayerUnit>());
