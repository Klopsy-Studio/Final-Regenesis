    ...
    public void LoadPanels()
    {
        ...
        for (int i = 0; i < weaponUpgradeSystem.allWeaponsTrees.Length; i++)
        {
            ...
            for (int w = 0; w < weaponUpgradeSystem.allWeaponsTrees[i].weaponUpgrade.Length; w++)
            {
                ...
                weaponTreeTemplateList[i].weaponInfoTemplateList[w].elementEffectiveness = weaponUpgradeSystem.allWeaponsTrees[i].weaponUpgrade[w].weapon.WeaponPowerElement.ToString();
